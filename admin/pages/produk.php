            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <!-- EDIT BTN -->
                            <button type="button" id="edit-btn" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-modal" data-nama="<?= $data['nama'] ?>" data-id="<?= $data['id_produk'] ?>" data-jumlah="<?= $data['jumlah'] ?>" data-harga="<?= $data['harga'] ?>" data-foto="<?= $data['foto'] ?>">
